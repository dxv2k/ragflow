...
/**
 * MonkeyOCR Configuration Component
 *
 * Provides configuration options for MonkeyOCR parser, which is an alternative
 * to DeepDoc for PDF processing. Uses the same configuration structure as naive parser.
 */
export function MonkeyOCRConfiguration() {
  return (
