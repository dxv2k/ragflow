...
def fill_spans_in_blocks(blocks, spans, radio):
    ...
    for block in blocks:
        ...
        if block_type in [BlockType.ImageBody, BlockType.ImageCaption, BlockType.ImageFootnote, BlockType.TableBody, BlockType.TableCaption, BlockType.TableFootnote]:
...
def fix_block_spans_v2(block_with_spans):
    ...
    for block in block_with_spans:
        ...
        if block_type in [BlockType.Text, BlockType.Title, BlockType.ImageCaption, BlockType.ImageFootnote, BlockType.TableCaption, BlockType.TableFootnote]:
